...
export default function Cart() {
  ...
  const { getLoggeedCart,updateProduct,deletSpacificItem,setNumOfCartItems } = useContext(CarteContext);
  ...
  async function deleteProduct(id) {
    let { data }=await deletSpacificItem(id)
...
setAllData(data.data.products);
  ...
  return <div className='container'>
      <h1 className='text-2xl text-green-500 text-center font-bold my-8 ht-4'>Shopping Cart</h1>

<div className='flex justify-end'>
<Link to={'/CheckOut'} className='bg-green-500 p-2 rounded my-2 text-white'>Check Out</Link>
